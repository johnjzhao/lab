...
module "s3_to_tdv_data_load_glue_job" {
  source = "./modules/glue"

  cloudwatch_log_group_name = "/aws-glue/jobs/${var.gov_solutions_commissions_s3_to_tdv_data_load_job}"
  retention_in_days         = 14

  name                = var.gov_solutions_commissions_s3_to_tdv_data_load_job
  description         = "Data load Job - S3 To TDV Tables"
  ...
  script_location     = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_script_key}/${var.gov_solutions_commissions_s3_to_tdv_data_load_path}"
  ...
  arguments = tomap(
    {
      "--scriptLocation"       = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_script_key}/${var.gov_solutions_commissions_s3_to_tdv_data_load_path}"
      ...
      "--custom_log_group"     = "/aws-glue/jobs/${var.gov_solutions_commissions_s3_to_tdv_data_load_job}"
    }
  )
