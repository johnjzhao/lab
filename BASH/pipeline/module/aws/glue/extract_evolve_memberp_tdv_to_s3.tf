...
module "evolve_memberp_extract_tdv_to_s3_glue_job" {
  source = "./modules/glue"

  cloudwatch_log_group_name = "/aws-glue/jobs/${var.gov_solutions_commissions_tdv_to_s3_evolve_memberp_job}"
  retention_in_days         = 14

  name                = var.gov_solutions_commissions_tdv_to_s3_evolve_memberp_job
  ...
  script_location     = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_script_key}/${var.gov_solutions_commissions_tdv_to_s3_evolve_memberp_path}"
  ...
  arguments = tomap(
    {
      "--scriptLocation"         = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_script_key}/${var.gov_solutions_commissions_tdv_to_s3_evolve_memberp_path}"
      ...
      "--custom_log_group"       = "/aws-glue/jobs/${var.gov_solutions_commissions_tdv_to_s3_evolve_memberp_job}"
...
resource "aws_glue_crawler" "evolve_memberp_crawler" {
  database_name = var.aws_glue_catalog_database.name
  name          = "gov_solutions_commissions_evolve_memberp_crawler"
  role          = var.glue_role_arn
  s3_target {
    path = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_key}/extracts/tdv_data/memberp_evolve/"
  }
