...
module "pcs_member_sales_agent_extract_glue_job" {
  source = "./modules/glue"

  cloudwatch_log_group_name = "/aws-glue/jobs/${var.gov_solutions_commissions_tdv_to_s3_pcs_member_sales_agent_job}"
  retention_in_days         = 14

  name                = var.gov_solutions_commissions_tdv_to_s3_pcs_member_sales_agent_job
  description         = "PCS Member Sales Agent Data Extract Job"
  ...
  script_location     = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_script_key}/${var.gov_solutions_commissions_tdv_to_s3_member_sales_agent_path}"
  ...
  arguments = tomap(
    {
      "--scriptLocation"       = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_script_key}/${var.gov_solutions_commissions_tdv_to_s3_member_sales_agent_path}"
      ...
      "--custom_log_group"     = "/aws-glue/jobs/${var.gov_solutions_commissions_tdv_to_s3_pcs_member_sales_agent_job}"
      "--run_job_name"         = "tdv_to_s3_extract_member_sales_agent_pshell"
...
/*
resource "aws_glue_crawler" "pcs_member_sales_agent_crawler" {
  database_name = var.aws_glue_catalog_database.name
  name          = "gov_solutions_commissions_pcs_member_sales_agent"
  role          = var.glue_role_arn
  s3_target {
    path = "s3://${var.artifacts_bucket}/${var.artifacts_bucket_key}/extracts/member_sales_agent/"
  }
