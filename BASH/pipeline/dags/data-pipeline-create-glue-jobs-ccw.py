...
dag_id = f'{REPO_NAME}-create-glue-jobs-ccw' # ALL DAG_IDs MUST begin with the REPO NAME, i.e. if repo name is 'tdv-oss-demo', dag_id = 'tdv-oss-demo-create-glue-jobs'
...
script_path = f"s3://{TDV_GLOBAL_CONFIG['glue_s3_bucket']}/{REPO_NAME}/scripts/tdv_glue_runner2.py" # If you wish to use our pre-made script, keep this as is. 
...
with DAG(dag_id = dag_id, default_args = default_args, schedule_interval = None) as dag:
    create_glue_job_ccw = CustomGlueJobOperator(
